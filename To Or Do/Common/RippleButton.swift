...
//  To Or Do Project
//
//  Created by Emre Önder on 7/24/18.
//  Copyright © 2018 Emre Önder. All rights reserved.
//
...
open class RippleButton: UIButton {
    ...
    @IBInspectable open var rippleColor: UIColor = UIColor(white: 0.9, alpha: 0.6) {
        didSet {
    ...
    convenience init() {
        ...
        self.backgroundColor = Colors.lightPurple
